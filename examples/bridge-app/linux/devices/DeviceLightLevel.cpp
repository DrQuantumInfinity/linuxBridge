...
const EmberAfDeviceType bridgedDeviceTypes[] = { {.deviceTypeId = 0x0101, .deviceTypeRevision = DEVICE_VERSION_DEFAULT },
                                                 {.deviceTypeId = DEVICE_TYPE_BRIDGED_NODE,
                                                   .deviceTypeRevision = DEVICE_VERSION_DEFAULT } };
/**************************************************************************
 *                                  Macros
 **************************************************************************/
/**************************************************************************
