...
const EmberAfDeviceType bridgedDeviceTypes[] = { 
     {.deviceTypeId = DEVICE_TYPE_TEMP_MEASURE, .deviceTypeRevision = DEVICE_VERSION_DEFAULT},
    //  {.deviceTypeId = DEVICE_TYPE_HUMID_MEASURE, .deviceTypeRevision = DEVICE_VERSION_DEFAULT},
    //  {.deviceTypeId = DEV_THEMOSTAT, .deviceTypeRevision = DEVICE_VERSION_DEFAULT},
     {.deviceTypeId = DEVICE_TYPE_BRIDGED_NODE,  .deviceTypeRevision = DEVICE_VERSION_DEFAULT} 
};
/**************************************************************************
 *                                  Macros
 **************************************************************************/
