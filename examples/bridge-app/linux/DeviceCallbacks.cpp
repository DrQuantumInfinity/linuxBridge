...
{
    log_info("PostAttributeChangeCallback - Cluster ID: '0x%" PRIx32 "', EndPoint ID: '0x%x', Attribute ID: '0x%" PRIx32 "'",
             clusterId, endpointId, attributeId);
    log_info("Current free heap: %d\n", heap_caps_get_free_size(MALLOC_CAP_8BIT));
}
...
{
    log_info("Read %lu, %lu", aPath.mClusterId, aPath.mAttributeId);
