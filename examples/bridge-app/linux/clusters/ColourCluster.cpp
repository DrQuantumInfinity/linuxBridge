...
Status ColourCluster::Write(chip::AttributeId attributeId, uint8_t * buffer)
{
...
Status ColourCluster::Read(chip::AttributeId attributeId, uint8_t * buffer, uint16_t maxReadLength)
{
