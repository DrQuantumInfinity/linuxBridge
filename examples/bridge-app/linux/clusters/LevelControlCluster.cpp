...
Status LevelControlCluster::Write(chip::AttributeId attributeId, uint8_t * buffer)
{
...
Status LevelControlCluster::Read(chip::AttributeId attributeId, uint8_t* buffer, uint16_t maxReadLength){
    Status status = Status::Success;
