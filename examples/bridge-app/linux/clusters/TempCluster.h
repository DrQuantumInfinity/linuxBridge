...
public:
    ...
    Status Write(chip::AttributeId attributeId, uint8_t * buffer) override;
    Status Read(chip::AttributeId attributeId, uint8_t * buffer, uint16_t maxReadLength) override;
